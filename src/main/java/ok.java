...
class ok {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("DP TSP algorithm: ");
        // finding the time before the operation is executed
        start = System.currentTimeMillis();
        // Finds the shortest path cost with the Approximation algorithm (Using DFS)
        DynamicProgrammingTSP dynamicProgrammingTSP = new DynamicProgrammingTSP(graph);
        System.out.println("Path cost: " + dynamicProgrammingTSP.getShortestPathCost());
        bestPath =  dynamicProgrammingTSP.getShortestPath();
